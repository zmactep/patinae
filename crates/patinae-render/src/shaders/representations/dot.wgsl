// Dot representation — one atom instance, procedural screen-space quads per
// surface sample. Color from the scene-wide colour LUT.
//
...
fn fs_main(input: VsOut) -> TranslucentOut {
    ...
    let base = scene_dot_color(global_id);
